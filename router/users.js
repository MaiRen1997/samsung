    ...
    .post((req, res, next) => {
        ...
        conn.query(searchUser, (err, results) => {
            ...
            if (results.length) {
                ...
                // console.log(req.body);
                let sql = `insert into users(username, password,phoneNum,email, address) values('${req.body.username}','${req.body.password}','${req.body.phone}','${req.body.email}','${req.body.address}')`;
